...
function ngReduxProvider() {
  ...
  this.$get = function ($injector) {
    ...
    var resolvedFirstEnhancers = map(_firstStoreEnhancers, resolveStoreEnhancer);
    if (_reducerIsObject) {
    ...
    var middleware = redux.applyMiddleware.apply(undefined, _toConsumableArray(resolvedMiddleware));
    var enhancer = redux.compose.apply(undefined, _toConsumableArray(resolvedFirstEnhancers).concat([middleware], _toConsumableArray(resolvedStoreEnhancer)));
    var store = redux.createStore(_reducer, _initialState, enhancer);
